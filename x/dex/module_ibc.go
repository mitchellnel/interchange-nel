...
func (am AppModule) OnRecvPacket(
	...
	var modulePacketData types.DexPacketData
	...
	case *types.DexPacketData_CreatePairPacket:
	...
	case *types.DexPacketData_SellOrderPacket:
	...
	case *types.DexPacketData_BuyOrderPacket:
