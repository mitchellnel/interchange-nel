...
import InterchangeNelInterchangenelDex from './interchange-nel/interchangenel.dex'
...
export default { 
  ...
  InterchangeNelInterchangenelDex: load(InterchangeNelInterchangenelDex, 'interchangenel.dex'),
